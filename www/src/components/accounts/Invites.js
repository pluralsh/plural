...
function InviteHeader() {
  return (
    <TableRow>
      <HeaderItem text='Email' width='40%' />
      <HeaderItem text='Link' width='40%' />
...
function InviteRow({invite}) {
  return (
    <TableRow>
      <HeaderItem text={invite.email} width='40%' />
      <Box width='40%' align='center' direction='row'>
        <Copyable text={inviteLink(invite)} pillText='Copied invite link' />
      </Box>
      <Box direction='row' width='20%' align='center'>
        <Box fill='horizontal'>
