...
import { SECTION_CLI_INSTALLATION } from '../../../constants'
...
function OnboardingCliInstallation() {
  const { previousTo, nextTo } = useOnboardingNavigation(SECTION_CLI_INSTALLATION)
...
export default OnboardingCliInstallation
