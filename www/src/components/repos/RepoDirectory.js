    ...
    >
        ...
        >
          ...
          >
            ...
            <SectionItem
              ...
              icon={Update}
            />
            {repository.artifacts && repository.artifacts.length > 0 && (
              <SectionItem
                name="artifacts"
                label="Artifacts"
                icon={Install}
      ...
      <Box fill>
        ...
        <SectionContent
          name="configure"
          subgroup="oidc"
          header="Configure OIDC Provider"
        >
        ...
        <SectionContent
          name="edit"
          subgroup="details"
          header="Edit Repository Information"
        >
        ...
        <SectionContent
          name="edit"
          subgroup="secrets"
          header="Edit Repository Secrets"
        >
