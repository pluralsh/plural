import {
  CONSOLE_LOCAL_STORAGE_KEY, ONBOARDING_CHECKLIST_STATE, PROVIDER_LOCAL_STORAGE_KEY, SELECTED_APPLICATIONS_LOCAL_STORAGE_KEY, SHOULD_USE_ONBOARDING_TERMINAL_SIDEBAR_LOCAL_STORAGE_KEY, STACK_NAME_LOCAL_STORAGE_KEY,
