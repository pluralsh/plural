...
import TerminalThemeContext, { TerminalThemeContextType } from '../../../contexts/TerminalThemeContext'
...
function TerminalThemeProvider({ children }) {
  ...
  const terminalThemeValue = useMemo<TerminalThemeContextType>(() => [terminalTheme, setTerminalTheme], [terminalTheme])
