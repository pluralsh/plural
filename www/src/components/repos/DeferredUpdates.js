...
function DeferredUpdateHeader() {
  return (
    <Box pad='small' flex={false} direction='row' gap='xsmall' height={ROW_HEIGHT} align='center' border={{side: 'bottom', color: 'light-5'}}>
      <HeaderItem text='version' width='30%' />
      <HeaderItem text='dequeueable at' width='30%' />
      <HeaderItem text='created' width='30%' />
      <HeaderItem text='attempts' width='10%' />
    </Box>
  )
}
...
function DeferredUpdate({deferred}) {
  return (
    <Box pad='small' flex={false} direction='row' gap='xsmall' height={ROW_HEIGHT} align='center' border={{side: 'bottom', color: 'light-3'}}>
      <HeaderItem text={deferred.version.version} width='30%' />
      <HeaderItem text={format(deferred.dequeueAt)} width='30%' nobold />
      <HeaderItem text={format(deferred.insertedAt)} width='30%' nobold />
      <HeaderItem text={deferred.attempts} width='10%' nobold />
    </Box>
  )
}
