...
function Provider({ props, provider, setValid, setProps }: ProviderProps) {
      ...
      <FormField
        ...
        hint={
          <Span
            ...
            color="text-xlight"
          >
            If you want to change your cloud provider you must destroy your
            cluster or set up a new cluster on another user or&nbsp;
            <A
              inline
              href=""
              target="_blank"
